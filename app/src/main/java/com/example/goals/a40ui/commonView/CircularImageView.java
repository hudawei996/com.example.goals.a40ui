package com.example.goals.a40ui.commonView;
...
import com.example.goals.a40ui.R;


/**
 * 圆形显示图片
 *
 * Created by huyongqiang on 2017/6/14.
...
public class CircularImageView extends ImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        // load the styled attributes and updateView their properties
        ...
        if (hasSelector) {
            ...
            setSelectorStrokeWidth(attributes
                    .getDimensionPixelOffset(R.styleable.CircularImageView_selector_stroke_width, defaultSelectorSize));
    ...
    public void onDraw(Canvas canvas) {
        // Don't draw anything without an bitmap
        if (bitmap == null)
            return;
        ...
        // Reinitialize bitmapShader, if necessary
        if (oldCanvasSize != canvasSize)
            refreshBitmapShader();

        // Apply bitmapShader to paint
        ...
        // Draw the circular bitmap itself
        canvas.drawCircle(center + outerWidth, center + outerWidth, ((canvasSize - (outerWidth * 2)) / 2) - 4.0f,
                paint);
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        // Redraw bitmap and return super type
        this.invalidate();
    ...
    public void invalidate(Rect dirty) {
        ...
        if (bitmapShader != null || canvasSize > 0)
            refreshBitmapShader();
    }
    ...
    /**
     * Reinitializes the bitmapShader texture used to fill in the Circle upon drawing.
     */
    public void refreshBitmapShader() {
        bitmapShader = new BitmapShader(Bitmap.createScaledBitmap(bitmap, canvasSize, canvasSize, false),
